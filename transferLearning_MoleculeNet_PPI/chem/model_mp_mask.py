...
class GNN_mp_mask(torch.nn.Module):
    def __init__(self, num_motifs, num_layer, emb_dim, JK = "last", drop_ratio = 0, 
            enc_dropout = 0, tfm_dropout = 0, dec_dropout = 0, 
            enc_ln = True, tfm_ln = False, conc_ln = False, num_heads=4, 
            graph_pooling = "mean", gnn_type = "gin"):
        super(GNN_mp_mask, self).__init__()
